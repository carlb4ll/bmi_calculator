function bmicalc() {
  ...
  if (roundbmi < 18.5) {
    result.textContent = "Your BMI is " + roundbmi;
    category.textContent = "You are classed as underweight";
  } else if (roundbmi < 24.9) {
    result.textContent = "Your BMI is " + roundbmi;
    category.textContent = "You are classed as normal healthy weight";
  } else if (roundbmi < 29.9) {
    result.textContent = "Your BMI is " + roundbmi;
    category.textContent = "You are classed as overweight";
  } else if (roundbmi < 39.9) {
    result.textContent = "Your BMI is " + roundbmi;
    category.textContent = "You are classed as obese";
  } else if (roundbmi >= 40.0) {
    result.textContent = "Your BMI is " + roundbmi;
    category.textContent = "You are classed as morbidly obese";
  }
}
